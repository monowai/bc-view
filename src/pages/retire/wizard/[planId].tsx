...
import { toPercent } from "@lib/retire/conversions"
import { PlanWithExpensesResponse, WizardFormData } from "types/retirement"
...
function EditPlanWizard(): React.ReactElement {
  ...
  const { data, error, isLoading } = useSwr<PlanWithExpensesResponse>(
    planId ? `/api/retire/plans/${planId}/details` : null,
    planId ? simpleFetcher(`/api/retire/plans/${planId}/details`) : null,
    {
