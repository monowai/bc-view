  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <p className="text-gray-600 mb-6">
        {
          "Here's a summary of your data in Beancounter. You can choose what to delete in the following steps."
        }
      </p>
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="font-medium">{"Model Portfolios"}</span>
          </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <div className="flex items-start">
          ...
          <p className="text-yellow-700 text-sm">
            {
              "Data deletion is permanent and cannot be undone. Please review carefully before proceeding."
            }
          </p>
        </div>
      </div>
