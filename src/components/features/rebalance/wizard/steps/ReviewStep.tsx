    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder={"e.g., Q1 2024 Rebalance"}
        />
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <div className="px-4 py-3 bg-gray-50 border-b">
          <h4 className="font-medium text-gray-700">{"Plan Summary"}</h4>
        </div>
        <div className="divide-y divide-gray-200">
          <div className="px-4 py-3 flex justify-between">
            <span className="text-gray-600">{"Model Portfolio"}</span>
          ...
          <div className="px-4 py-3 flex justify-between">
            ...
            <span className="font-medium">
              {scenario === "INVEST_CASH" ? "Invest Cash" : "Rebalance"}
            </span>
          </div>
          {cashDelta !== 0 && (
            <div className="px-4 py-3 flex justify-between">
              <span className="text-gray-600">{"Cash Delta"}</span>
              <span
