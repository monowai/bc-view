  ...
  return (
    ...
    >
      ...
      <div className="border-t pt-4 mt-4">
        <h3 className="text-sm font-medium text-gray-700 mb-3">Return Rates</h3>
      ...
      <div className="border-t pt-4 mt-4">
        <h3 className="text-sm font-medium text-gray-700 mb-3">Portfolios</h3>
                      ...
                      onChange={() => {
                        setFormData((prev) => ({
                          ...
                          excludedRentalAssetIds: isExcluded
                            ...
                            : [...prev.excludedRentalAssetIds, config.assetId],
                        }))
                      }}
