...
describe("calculate function", () => {
  it("should compute totals when hiding exited positions", () => {
    ...
    expect(result.totals["TRADE"].purchases).toEqual(2000);
    expect(result.totals["PORTFOLIO"].purchases).toEqual(2000);
    expect(result.totals["BASE"].purchases).toEqual(2000);
  });
